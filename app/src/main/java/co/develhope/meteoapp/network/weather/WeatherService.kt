...
import co.develhope.meteoapp.network.weather.DTO.WeatherResponse
...
suspend fun getWeatherResponse(@Query("latitude")latitude:Double,@Query("longitude")longitude :Double): WeatherResponse
}